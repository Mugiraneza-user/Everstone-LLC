  ...
  return (
    <footer style={{ borderTop: "1px solid var(--border)", background: "var(--bg-card)" }}>
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "72px 48px 40px" }}>
        ...
        <div style={{ borderTop: "1px solid var(--border)", paddingTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))" }} className="footer-bottom">
